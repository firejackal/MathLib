...
namespace FarseerPhysics.DebugViews
{
    ...
    public class DebugViewXNA : DebugViewBase, IDisposable
    {
        ...
        private void DrawJoint(Joint joint)
        {
            ...
            switch(joint.JointType) {
                ...
                case JointType.Pulley:
                    ...
                    Vector2 s1 = pulley.WorldAnchorA; //pulley.GroundAnchorA;
                    Vector2 s2 = pulley.WorldAnchorB; //pulley.GroundAnchorB;
                ...
                //case JointType.Prismatic:
                    //PrismaticJoint pris = (PrismaticJoint)joint;
                    //DrawSegment(p1, p2, color);
                    //DrawArrow(p2, p2 + (pris.Axis * 0.3f), 0.3f, 0.3f, false, Color.Red);
                    //break;
        ...
        public void LoadContent(GraphicsDevice device, ContentManager content)
        {
            ...
            if(content != null) _font = content.Load<SpriteFont>("font");
